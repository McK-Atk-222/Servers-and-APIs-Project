# Weather App Servers and APIs Project

## Description
A weather app that calls on OpenWeather API for current weather and 5-day forecast data. It has a history function that saves cities that have been searched.
